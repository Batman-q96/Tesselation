// Initial_Gui.cpp : Defines the entry point for the application.
//
...
int APIENTRY wWinMain(_In_ HINSTANCE hInstance,
    ...
    LoadStringW(hInstance, IDC_INITIALGUI, szWindowClass, MAX_LOADSTRING);
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
    ...
    wcex.hIcon          = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_INITIALGUI));
    wcex.hCursor        = LoadCursor(nullptr, IDC_ARROW);
    wcex.hbrBackground  = (HBRUSH)(COLOR_WINDOW+1);
    wcex.lpszMenuName   = MAKEINTRESOURCEW(IDC_INITIALGUI);
